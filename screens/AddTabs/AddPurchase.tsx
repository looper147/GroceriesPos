      ...
      <ScrollView>
        ...
        <View style={styles.card}>
          ...
          >
            ...
            <Dropdown data={categories} searchPlaceHolder="Ex. Fruits" />
          </View>
          ...
          <View style={{ padding: 10, flex: 1 }}>
            ...
            <Dropdown data={items} searchPlaceHolder="Ex. banana" />
          </View>
        </View>
        ...
        <View style={styles.card}>
          <View style={{ flex: 1 }}>
            <Text style={{ fontSize: 25, fontWeight: "200" }}>
              Current Availability in stock market: e.g 1321KG
            </Text>
          </View>
        </View>
        ...
        >
          <View style={{ flex: 1 }}>
            <TouchableOpacity style={styles.confirmButton}>
              <Text style={{ color: "#ffffff" }}>Confirm new purchase</Text>
            </TouchableOpacity>
          </View>
        </View>
      </ScrollView>
